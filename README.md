...
Hello! I'm **Neel Jasani**, a passionate **Computer Engineer** based in **Ahmedabad**. With a strong background in **Web Development**, I've gained hands-on experience in MERN-stack development, ensuring clean code practices, scalability, and responsive design. I thrive on creating **innovative solutions**.
...
- **Technology:** I'm always exploring new technologies and tools to expand my skillset, including **HTML, CSS (Tailwind), Bootstrap, JavaScript, ReactJS, React Native, NodeJS, Sequelize, Material UI**.
...
- Lead a team specializing in front-end development using **JavaScript, ReactJS** to create responsive websites.
...
- **Upgraded React Native** from an older version to the latest version, resolving deprecated packages while maintaining existing functionality.
- **Resolved a 16 KB build size issue** by updating dependencies and adding required packages, ensuring successful application build and deployment.
...
- front-end development using **JavaScript, TypeScript, ReactJS** to create responsive websites.
...
**Graduation:** 2021 | **Institution:** Aspire Public School - Surat | **Percentage:** 80.76%

### 10th Standard | GSEB | SSC Board
**Graduation:** 2019 | **Institution:** Aspire Public School - Surat | **Percentage:** 79.83%
...
- **Mobile:**
  ![React Native](https://img.shields.io/badge/-React%20Native%20(Android%20%26%20iOS)-61DAFB?style=flat&logo=react&logoColor=black)
...
<a href="http://www.github.com/neel1502"><img src="https://github-readme-activity-graph.vercel.app/graph?username=neel1502&bg_color=1a1b27&color=70a5fd&line=bf91f3&point=70a5fd&area_color=1a1b27&area=true&hide_border=true&custom_title=GitHub%20Commits%20Graph" alt="GitHub Commits Graph" /></a>
...
<div align="center">
  <img src="https://streak-stats.demolab.com?user=neel1502&locale=en&mode=daily&theme=dark&hide_border=false&border_radius=5&order=3" height="220" alt="streak graph" />
</div>
